...
export function ManageView({ onExit }: { onExit: () => void }) {
  ...
  return (
    <div className="flex h-screen min-w-[1180px] flex-col bg-panel">
      ...
      <div
        className={`grid min-h-0 flex-1 ${
          previewOpen
            ? "grid-cols-[224px_minmax(520px,1fr)_520px]"
            : "grid-cols-[224px_minmax(0,1fr)]"
        }`}
      >
        {/* Rail: which room, or the shared library */}
        <aside className="flex min-h-0 flex-col gap-4 overflow-y-auto border-r border-border bg-white px-3 pt-4 pb-4">
          <div className="flex flex-col gap-1.5">
            ...
            {creating ? (
              <div className="mt-1 flex flex-col gap-2 rounded-md border border-border bg-row-hover p-2.5">
                <TextField
                  label="Company"
                  value={newCompany}
              ...
              <button
                ...
                className="mt-0.5 cursor-pointer rounded-md border border-dashed border-border-dashed bg-transparent px-2.5 py-2 text-left font-sans text-[12px] font-bold text-muted transition-colors hover:border-blue hover:text-navy"
              >
                + New room
              </button>
            )}
          ...
          <div className="flex flex-col gap-1.5 border-t border-border-soft pt-3">
            <span className="px-1 font-mono text-[10px] tracking-[0.12em] text-faint uppercase">
              Shared
            </span>
            <button
            ...
            >
              <ImageIcon className="flex-none text-faint" />
              <span
                className={`truncate text-[12.5px] ${
                  scope === "library" ? "font-bold text-navy" : "text-body"
                }`}
              >
                Asset library
              </span>
          ...
          <button
            ...
            className="mt-auto w-full cursor-pointer rounded-md border-none bg-transparent px-2.5 py-1.5 text-left font-sans text-[11px] text-faint transition-colors hover:text-red"
          >
